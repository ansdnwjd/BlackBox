...
public class Gps extends AppCompatActivity implements AutoPermissionsListener {
    ...
    private void showMyLocationMarker(LatLng curPoint) {
        if (myLocationMarker == null) {
            ...
            myLocationMarker.icon(BitmapDescriptorFactory.fromResource((R.drawable.google)));
